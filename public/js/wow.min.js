    ...
    h =
      ...
      ((s = i =
        (function () {
          ...
          return o(t, [{ key: "observe", value: function t() {} }]), t;
        })()),
      (i.notSupported = !0),
      s),
    c =
      ...
      return (
        o(t, [
          ...
          },
          {
            ...
            value: function t(e) {
              if ((null == e && (e = this.element), 1 === e.nodeType))
                for (
                  var n = (e = e.parentNode || e).querySelectorAll(
                      "." + this.config.boxClass
                    ),
                    i = 0;
                  i < n.length;
          ...
          },
          {
            ...
            value: function t(e, n) {
              for (
                var i = c(e), s = i.getPropertyCSSValue(n), o = 0;
                o < this.vendors.length;
                o++
              ) {
                var a = this.vendors[o];
                s = s || i.getPropertyCSSValue("-" + a + "-" + n);
              }
              return s;
            },
          },
