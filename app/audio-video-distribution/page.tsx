        ...
        <div className="page-content">
          <div className="page-breadcrumb">
            <div aria-label="breadcrumb" className="viewbreadcrumb text-center">
              <h2 className="text-white text-center">Audio / Video Distribution</h2>
            </div>
          </div>
                    ...
                    <div className="col-lg-6 col-md-12 m-b30 about-max-two-position">
                      <div className="about-section-two-right">
                        ...
                        <div className="section-head left ">
                          ...
                          <p>
                            Seamless communication and high-quality media delivery are vital in today’s connected environments. At Pyronics, we design and integrate advanced audio and video distribution solutions that enhance collaboration, simplify content sharing, and deliver consistent user experiences across diverse spaces. Our systems are ideal for smart workplaces, hospitality environments, control rooms, and public venues. <br />
                            From IPTV and video walls to intercom and centralized control systems, Pyronics delivers AV technologies engineered for clarity, reliability, and control. Whether improving internal communication or creating impactful visual displays, our scalable and intuitive solutions are built to perform today and adapt for the future.{" "}
                          </p>
                        </div>
            ...
            <div className="services-core-container">
              ...
              <div className="services-core-grid">
                ...
                <div className="services-core-item">
                  ...
                  <i className="services-core-icon fa-solid fa-tv" />
                  <h4>IPTV / CATV Solutions</h4>
                  <p>
                    High-quality IPTV and CATV systems delivering live and on-demand
                    content across IP networks with scalable, centrally managed
                    distribution.
                  </p>
                </div>

                {/* 02 Conference & Meeting Rooms */}
                <div className="services-core-item">
                  <span className="services-core-number">02</span>
                  <i className="services-core-icon fa-solid fa-chalkboard-user" />
                  <h4>Conference & Meeting Room Solutions</h4>
                  <p>
                    Fully integrated audio-visual solutions enabling seamless meetings
                    with crystal-clear sound, sharp visuals, and intuitive control
                    systems.
                  </p>
                </div>
                ...
                <div className="services-core-item">
                  ...
                  <i className="services-core-icon fa-solid fa-display" />
                  <h4>Digital Signage</h4>
                  <p>
                    Centrally managed digital signage platforms designed for impactful
                    communication, real-time updates, promotions, and announcements.
                  </p>
                </div>
                ...
                <div className="services-core-item">
                  ...
                  <i className="services-core-icon fa-solid fa-border-all" />
                  <h4>Video Walls</h4>
                  <p>
                    High-resolution video wall solutions for immersive visual experiences,
                    ideal for control rooms, command centers, retail, and public spaces.
                  </p>
                </div>
                ...
                <div className="services-core-item">
                  ...
                  <i className="services-core-icon fa-solid fa-microphone-lines" />
                  <h4>Network &amp; Analog Intercom Systems</h4>
                  <p>
                    Reliable IP-based and analog intercom systems ensuring secure, clear
                    communication across buildings, zones, and large facilities.
                  </p>
                </div>
                ...
                <div className="services-core-item">
                  ...
                  <i className="services-core-icon fa-solid fa-bullhorn" />
                  <h4>Emergency Paging Systems</h4>
                  <p>
                    Mission-critical paging solutions delivering instant, clear
                    announcements during emergencies to enhance safety and response
                    coordination.
                  </p>
                </div>
