        ...
        <div className="page-content">
          <div className="page-breadcrumb">
            <div aria-label="breadcrumb" className="viewbreadcrumb text-center">
              <h2 className="text-white text-center">Fire & Safety</h2>
            </div>
          </div>
          {/* About Section */}
                    ...
                    <div className="col-lg-6 col-md-12 m-b30 about-max-two-position">
                      <div className="about-section-two-right">
                        ...
                        <div className="section-head left ">
                          ...
                          <p>
                            Protecting people, assets, and critical operations begins with a reliable fire and safety infrastructure. At Pyronics, we design and deploy intelligent fire detection and emergency response systems that deliver early warnings, enable safe evacuations, and ensure compliance with the highest safety standards. Our solutions are engineered for rapid response and dependable performance in high-risk environments. <br />
                            From advanced fire alarm systems to voice evacuation and emergency lighting, Pyronics provides end-to-end fire and safety solutions for secure, compliant facilities. Whether for commercial buildings, data centers, or industrial operations, we ensure your fire and safety infrastructure is always prepared when it matters most.{" "}
                          </p>
                        </div>
          ...
          <section className="services-core-section">
            <div className="services-core-container">
              ...
              <div className="services-core-grid">
                ...
                {/* 01 Fire Alarm & Detection */}
                <div className="services-core-item">
                  <span className="services-core-number">01</span>
                  <i className="services-core-icon fa-solid fa-fire-extinguisher" />
                  <h4>Fire Alarm & Detection Systems</h4>
                  <p>
                    Advanced fire detection and alarm systems delivering real-time alerts
                    to minimize response time, protect life, and reduce damage to critical
                    assets.
                  </p>
                </div>
                ...
                <div className="services-core-item">
                  ...
                  <i className="services-core-icon fa-solid fa-volume-high" />
                  <h4>Voice Evacuation Systems</h4>
                  <p>
                    Automated voice evacuation solutions providing clear instructions
                    during emergencies to guide safe movement and prevent panic.
                  </p>
                </div>

                {/* 03 Mass Notification */}
                <div className="services-core-item">
                  <span className="services-core-number">03</span>
                  <i className="services-core-icon fa-solid fa-tower-broadcast" />
                  <h4>Mass Notification Systems</h4>
                  <p>
                    Instant, multi-channel emergency notifications across displays,
                    speakers, and mobile devices to keep occupants informed and safe.
                  </p>
                </div>

                {/* 04 Emergency & Exit Lighting */}
                <div className="services-core-item">
                  <span className="services-core-number">04</span>
                  <i className="services-core-icon fa-solid fa-lightbulb" />
                  <h4>Emergency & Exit Lighting</h4>
                  <p>
                    Reliable emergency lighting systems that activate during power failure,
                    clearly guiding occupants toward safe exit routes.
                  </p>
                </div>

                {/* 05 Early Warning Detection */}
                <div className="services-core-item">
                  <span className="services-core-number">05</span>
                  <i className="services-core-icon fa-solid fa-triangle-exclamation" />
                  <h4>Early Warning Detection</h4>
                  <p>
                    Sensitive early warning technologies that detect smoke, gas, or heat
                    at initial stages, enabling proactive safety action before escalation.
                  </p>
                </div>
                ...
                <div className="services-core-item">
                  ...
                  <h4>Surge Protection Systems</h4>
                  <p>
                    Comprehensive surge protection solutions that safeguard critical
                    infrastructure from voltage spikes, equipment damage, and fire risks.
                  </p>
                </div>
