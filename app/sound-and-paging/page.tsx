        ...
        <div className="page-content">
          <div className="page-breadcrumb">
            <div aria-label="breadcrumb" className="viewbreadcrumb text-center">
              <h2 className="text-white text-center">Sound & Paging</h2>
            </div>
          </div>
          {/* About Section */}
                    ...
                    <div className="col-lg-6 col-md-12 m-b30 about-max-two-position">
                      <div className="about-section-two-right">
                        ...
                        <div className="section-head left ">
                          ...
                          <p>
                            Clear and reliable communication is essential for day-to-day operations and critical situations alike. At Pyronics, we design and implement advanced sound and paging systems that ensure announcements, alerts, and emergency messages are delivered clearly and consistently across your facility. Our solutions are engineered for clarity, coverage, and dependable performance in all environments. <br />
                            Whether deployed in corporate offices, industrial facilities, or public spaces, Pyronics sound and paging systems provide effective communication that enhances safety, coordination, and operational efficiency.{" "}
                          </p>
                        </div>
            ...
            <div className="services-core-container">
              <div className="services-core-grid">
                ...
                <div className="services-core-item">
                  ...
                  <h4>IP Public Address Systems</h4>
                  <p>
                    Advanced network-based public address solutions delivering crystal-clear
                    audio, flexible zoning, and centralized control across large and complex
                    environments such as campuses, airports, hospitals, and industrial facilities.
                  </p>
                </div>

                {/* 02 Analog Public Address */}
                <div className="services-core-item">
                  <span className="services-core-number">02</span>
                  <i className="services-core-icon fa-solid fa-volume-high" />
                  <h4>Analog Public Address Systems</h4>
                  <p>
                    Reliable and cost-effective analog public address systems designed for
                    consistent sound distribution in schools, offices, warehouses, and public
                    areas where simplicity and durability matter most.
                  </p>
                </div>

                {/* 03 Audio Video Intercom */}
                <div className="services-core-item">
                  ...
                  <p>
                    Integrated audio and video intercom solutions enabling secure two-way
                    communication, visitor verification, and seamless access control for
