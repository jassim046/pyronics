...
// IMPORT THE SCRIPTS COMPONENT HERE
...
export default function DataCenterInfrastructure() {
  return (
    <>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 m-b30">
                      <div className="about-us-img">
                        <img src="images/tech/infrastructure.jpg" className="img-fluid" alt="Data Center" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="services-core-container">
              <div className="services-core-grid">
                ...
                <div className="services-core-item">
                  ...
                  <p>Integrated cabinets with power distribution, cooling, and remote monitoring.</p>
                </div>
                <div className="services-core-item">
                ...
                <div className="services-core-item">
                  ...
                  <p>Advanced environmental monitoring for optimal temperature and humidity control.</p>
                </div>
              </div>
            </div>
          </section>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="widget f-top-space">
                    ...
                    <ul className="widget_address">
                      ...
                      <li><i className="bi bi-map" /> <strong>Pyronics Engineering</strong><br /> Riyadh, KSA</li>
                    </ul>
                  </div>
                </div>
                <div className="col-lg-4 col-md-6">
      ...
      {/* CALL THE SCRIPTS COMPONENT HERE TO ENABLE THE MOBILE MENU */}
      <Scripts />
    </>
  );
}
