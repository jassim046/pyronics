        ...
        <div className="page-content">
          <div className="page-breadcrumb">
            <div aria-label="breadcrumb" className="viewbreadcrumb text-center">
              <h2 className="text-white text-center">Networking Solutions</h2>
            </div>
          </div>
                    ...
                    <div className="col-lg-6 col-md-12 m-b30 about-max-two-position">
                      <div className="about-section-two-right">
                        ...
                        <div className="section-head left ">
                          ...
                          <p>
                          A high-performance, secure network is the backbone of every modern digital enterprise. At Pyronics, we design and deploy robust networking solutions that enable seamless communication, efficient data flow, and uninterrupted connectivity across your organization. From single-site environments to complex multi-location networks, our infrastructures are built for speed, security, and scalability.                           <br />
                            From reliable wired networks to advanced software-defined and intelligent networking architectures, Pyronics delivers solutions tailored to your operational needs. We optimize your network not only for today’s performance demands but also for future expansion—providing the flexibility, control, and reliability required to succeed in a connected world.{" "}
                          </p>
                        </div>
  ...
  <div className="services-core-container">
    ...
    <div className="services-core-grid">
      ...
      <div className="services-core-item">
        ...
        <p>
          Modern software-defined WAN architectures that improve application
          performance, simplify centralized management, and significantly
          reduce operational costs across multiple branch locations.
        </p>
      </div>
      ...
      <div className="services-core-item">
        ...
        <i className="services-core-icon fa-solid fa-ethernet" />
        <h4>Wired Switches</h4>
        <p>
          High-performance enterprise-grade wired switches designed for stable,
          secure, and high-speed data transfer across core and access-layer
          network infrastructures.
        </p>
      </div>

      {/* 03 Wireless Switches */}
      <div className="services-core-item">
        <span className="services-core-number">03</span>
        <i className="services-core-icon fa-solid fa-wifi" />
        <h4>Wireless Switching Solutions</h4>
        <p>
          Flexible wireless switching solutions that deliver seamless,
          secure connectivity for users, devices, and high-density
          environments with centralized control.
        </p>
      </div>
      ...
      <div className="services-core-item">
        ...
        <i className="services-core-icon fa-solid fa-right-left" />
        <h4>Transmission & Media Converters</h4>
        <p>
          Reliable media conversion solutions that enable smooth data
          transmission across different cable types, distances, and
          network protocols without signal loss.
        </p>
      </div>
      ...
      <div className="services-core-item">
        ...
        <h4>KVM Infrastructure & Console</h4>
        <p>
          Centralized KVM infrastructure that provides secure access and
          control over multiple servers and systems, simplifying IT
