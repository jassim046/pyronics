        ...
        <div className="page-content">
          <div className="page-breadcrumb">
            <div aria-label="breadcrumb" className="viewbreadcrumb text-center">
              <h2 className="text-white text-center">Passive Infrastructure</h2>
            </div>
          </div>
                    ...
                    <div className="col-lg-6 col-md-12 m-b30 about-max-two-position">
                      <div className="about-section-two-right">
                        ...
                        <div className="section-head left ">
                          ...
                          <p>
                            A reliable IT environment starts with a well-engineered passive infrastructure. At Pyronics, we design and implement structured, efficient, and scalable physical infrastructure that forms the backbone of your network. Our solutions ensure consistent data transmission, simplified maintenance, and long-term reliability—supporting businesses as they grow and evolve.  <br />
                            From structured cabling and rack systems to grounding and cable management, Pyronics delivers precision-built passive infrastructure designed for performance and durability. Whether deploying a new facility or upgrading an existing setup, we create foundations that support high-speed connectivity and sustained operational excellence.{" "}
                          </p>
                        </div>
            ...
            <div className="services-core-container">
              ...
              <div className="services-core-grid">
                ...
                <div className="services-core-item">
                  ...
                  <p>
                    Smart and efficient cable routing solutions that improve airflow,
                    simplify maintenance, and deliver clean, clutter-free installations
                    across data centers and IT environments.
                  </p>
                </div>

                {/* 02 Structured Cabling */}
                <div className="services-core-item">
                  ...
                  <p>
                    High-quality structured cabling systems engineered for organized,
                    scalable, and high-speed data and voice transmission throughout
                ...
                <div className="services-core-item">
                  ...
                  <h4>Racks & Cabinets</h4>
                  <p>
                    Secure and space-efficient racks and cabinets designed to house
                    servers, switches, and networking equipment while ensuring optimal
                    airflow, accessibility, and protection.
                  </p>
                </div>

                {/* 04 Grounding & Bonding */}
                <div className="services-core-item">
                  <span className="services-core-number">04</span>
                  <i className="services-core-icon fa-solid fa-bolt" />
                  <h4>Grounding & Bonding</h4>
                  <p>
                    Essential grounding and bonding systems that safeguard equipment,
                    enhance electrical stability, and ensure compliance with safety
                    standards across your entire IT infrastructure.
                  </p>
                </div>
