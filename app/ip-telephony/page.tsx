                    ...
                    <div className="col-lg-6 col-md-12 m-b30 about-max-two-position">
                      <div className="about-section-two-right">
                        ...
                        <div className="section-head left ">
                          ...
                          <p>
                            IP Telephony is more than an upgrade—it’s a smarter, more flexible way to communicate and collaborate. At Pyronics, we help organizations transition from legacy phone systems to modern, IP-based telephony that supports hybrid workforces, simplifies communication management, and scales seamlessly with business growth. <br />
                            Built on Cisco’s industry-leading IP Telephony technology, our solutions deliver enterprise-grade security, reliability, and performance. From encrypted voice communications and centralized control to intelligent integrations, Pyronics ensures your communication infrastructure is powerful, secure, and future-ready. With expert deployment and a Cisco-powered foundation, your business stays connected, protected, and always ahead.{" "}
                          </p>
                        </div>
                      ...
                      <div className="about-section-two-right">
                        ...
                        <div className="section-head left wt-small-separator-outer">
                          <div style={{ textAlign: "left" }}>
                            <h2 className="section-title p-t30">What We Deliver</h2>
                          </div>

                          <p className="mb-0">
                            IP Telephony is more than a technical upgrade, it’s a smarter way to connect and collaborate. By replacing outdated phone systems with modern, IP-based calling, your business gains the agility to support hybrid teams, reduce operational complexity, and scale effortlessly as you grow.

                          </p>
                          <p><b> Key Components in Our IP Telephony Architecture:</b></p>
                        </div>
                      </div>
                    </div>
                    {/* TITLE START}
            ...
            <div className="services-core-container">
              <div className="services-core-grid">
                ...
                <div className="services-core-item">
                  ...
                  <i className="services-core-icon fa-solid fa-phone-volume" />
                  <h4>Cisco IP Phones</h4>
                  <p>
                    Enterprise-grade Cisco IP phones delivering high-definition audio,
                    intuitive user interfaces, and advanced communication features,
                    serving as the core endpoints of a modern IP telephony system.
                  </p>
                </div>

                {/* 02 Video Conferencing Stations */}
                <div className="services-core-item">
                  <span className="services-core-number">02</span>
                  <i className="services-core-icon fa-solid fa-video" />
                  <h4>Video Conferencing Stations</h4>
                  <p>
                    High-performance video conferencing stations enabling real-time
                    visual collaboration, making communication more personal,
                    productive, and effective for remote meetings and distributed teams.
                  </p>
                </div>
                ...
                <div className="services-core-item">
                  ...
                  <i className="services-core-icon fa-solid fa-diagram-project" />
                  <h4>Call Agents &amp; MCU</h4>
                  <p>
                    Intelligent call agents managing dial plans, call routing, and user
                    authentication, while MCUs efficiently handle multiparty voice and
                    video conferencing with high reliability.
                  </p>
                </div>
                ...
                <div className="services-core-item">
                  ...
                  <p>
                    Robust application servers hosting unified communication services
                    such as voicemail, auto-attendants, IVR, and call management tools,
                    enhancing overall call handling and user experience.
                  </p>
                </div>
                ...
                <div className="services-core-item">
                  ...
                  <h4>Routers &amp; Gateways</h4>
                  <p>
                    Secure and scalable routers and gateways that seamlessly connect
                    internal IP networks to external systems, translating communication
                    protocols and efficiently managing voice and video traffic.
                  </p>
                </div>

                {/* 06 IP Backbone & PSTN Connectivity */}
                <div className="services-core-item">
                  <span className="services-core-number">06</span>
                  <i className="services-core-icon fa-solid fa-globe" />
                  <h4>IP Backbone &amp; PSTN Connectivity</h4>
                  <p>
                    A resilient IP backbone routing all internal calls, with optional
                    PSTN gateways providing reliable external communication and
                    interoperability with traditional telephone networks.
                  </p>
                </div>
                ...
                <div className="services-core-item">
                  ...
                  <i className="services-core-icon fa-solid fa-plug-circle-bolt" />
                  <h4>PBX Integration</h4>
                  <p>
                    Seamless integration with existing legacy PBX systems, allowing
                    organizations to transition smoothly to Cisco-based IP telephony
