        ...
        <div className="page-content">
          <div className="page-breadcrumb">
            <div aria-label="breadcrumb" className="viewbreadcrumb text-center">
              <h2 className="text-white text-center">Time Synchronization</h2>
            </div>
          </div>
                    ...
                    <div className="col-lg-6 col-md-12 m-b30 about-max-two-position">
                      <div className="about-section-two-right">
                        ...
                        <div className="section-head left ">
                          ...
                          <p>
                            Accurate and consistent timekeeping is critical to the reliable operation of modern networks and facilities. At Pyronics, we deliver robust time synchronization solutions that ensure systems, devices, and applications across your infrastructure operate in precise alignment. Consistent timing enhances performance, coordination, security, and operational accountability. <br />
                            From master clock systems to GPS-based and network time servers, Pyronics offers scalable time synchronization solutions designed to adapt to environments of any size or complexity. Our solutions help organizations maintain timing accuracy, minimize errors, and ensure reliable communication and data integrity across critical operations.{" "}
                          </p>
                        </div>
          ...
          <section className="services-core-section">
            <div className="services-core-container">
              <div className="services-core-grid">
                ...
                {/* 01 Master Clock System */}
                <div className="services-core-item">
                  <span className="services-core-number">01</span>
                  <i className="services-core-icon fa-solid fa-clock" />
                  <h4>Master Clock Systems</h4>
                  <p>
                    Centralized master clock solutions that distribute accurate and synchronized
                    time signals to all connected clocks and systems, ensuring uniform timekeeping
                ...
                <div className="services-core-item">
                  ...
                  <h4>IP Clock Systems</h4>
                  <p>
                    Network-based IP clock systems providing real-time, synchronized time displays
                    over existing IT infrastructure, ideal for schools, hospitals, transport hubs,
                    corporate offices, and campuses.
                  </p>
                </div>

                {/* 03 Network Time Servers */}
                <div className="services-core-item">
                  <span className="services-core-number">03</span>
                  <i className="services-core-icon fa-solid fa-server" />
                  <h4>Network Time Servers</h4>
                  <p>
                    Reliable and secure network time servers designed to integrate seamlessly with
                    IT networks, keeping all digital systems, applications, and devices operating
                    on a unified and accurate clock.
                  </p>
                </div>

                {/* 04 GPS Time Synchronization Servers */}
                <div className="services-core-item">
                  <span className="services-core-number">04</span>
                  <i className="services-core-icon fa-solid fa-satellite-dish" />
                  <h4>GPS Time Synchronization Servers</h4>
                  <p>
                    High-precision GPS-based time synchronization servers delivering extremely
                    accurate and dependable time references for mission-critical environments such
                    as data centers, utilities, financial institutions, and industrial operations.
                  </p>
                </div>
